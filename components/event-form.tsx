      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="sm:col-span-2">
          ...
          <input
            ...
            className={field}
            placeholder="Oregon Convention Center"
          />
        </div>
        ...
        <div className="sm:col-span-2">
          ...
          <p className="mt-2 font-mono text-[10px] uppercase tracking-widest text-muted">
            PNG, JPEG, WEBP, GIF, or AVIF · Max 5 MB · Leave blank to keep the
            block color
          </p>
        ...
        <div className="sm:col-span-2">
          <label htmlFor="ticketUrl" className={labelClass}>
            Ticket URL <span className="text-muted">(optional)</span>
          </label>
          <input
            id="ticketUrl"
            name="ticketUrl"
