  ...
  await db
    ...
    .onConflictDoUpdate({
      ...
      set: {
        ...
        ticketOptions: sql`excluded.ticket_options`,
        celebrityName: sql`excluded.celebrity_name`,
        celebrityBio: sql`excluded.celebrity_bio`,
        celebrityImage: sql`excluded.celebrity_image`,
